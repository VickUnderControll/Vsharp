...
begin
richedit1.lines.loadFromFile('debug.txt');
end;
...
var
  Frase: string;
begin
  Frase := Form1.Parametro; // Recupera el valor del parámetro
...
begin
  ...
  LineNo := LineIndex + 1;
  Label1.Caption := 'Línea actual: ' + IntToStr(LineNo);
////pintar componentes
...
begin
  ...
  // Construye la línea de comandos con el nombre del archivo Python y los parámetros
  Params := 'py main.py debug.txt';

  // Ejecuta la línea de comandos en una nueva ventana de cmd
